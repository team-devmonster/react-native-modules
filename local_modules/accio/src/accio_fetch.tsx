...
// import { Holder } from "./accio_holder";
// import { AuthInterceptors } from "./accio_interceptors";
// import { FORMDATA_HEADERS_CONFIG, instance } from "./accio_instance";
...
// //   console.log('successsssssssss !!', router, holder, toastRef, lock);
// //   return 'true';
// // }
...
//   // if(!instanceInit) instanceInit.current = useRef<any>(false);
//   console.log('loading 0 - ', loading);
//   console.log('instanceInit 0 - ', instanceInit);
//   const fetchData = async({ params, loading_state = true }:{ params?:Form, loading_state?:boolean }) => {
//     console.log('instanceInit 1 - ', instanceInit?.current);
//     if(!instanceInit?.current){
//       console.log('instanceInit 2 - ', instanceInit?.current);
//       await AuthInterceptors({ holder, router, toastRef, lock });
//       console.log('instanceInit 3 - ', instanceInit?.current);
//       instanceInit.current = true;
//       console.log('instanceInit 4 - ', instanceInit?.current);
//     }
//     console.log('instanceInit 5 - ', instanceInit?.current);
